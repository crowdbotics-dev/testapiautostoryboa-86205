...
## Project Structure
    ...
    ├── testapiautostoryboa_86205  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_86205`
...
2. Clone this repo and `cd testapiautostoryboa_86205`
